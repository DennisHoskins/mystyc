...
interface UserEmotionalExpressionInteractionProps {
  planet1: PlanetType;
  planet2: PlanetType;
...
export default function UserEmotionalExpressionInteraction({
  planet1,
  planet2,
  sign1,
  sign2,
  label,
  description
}: UserEmotionalExpressionInteractionProps) {
  const [interaction, setInteraction] = useState<EmotionalInteraction | null>(null);
