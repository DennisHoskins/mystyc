...
export default function TourPanel({ user, updatedUser }: TourPanelProps) {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <div className='flex flex-col mb-10 mx-0 md:mx-10 space-y-6'>
        <TourPanelItem 
      ...
      <Button
        ...
        className="py-3 w-auto min-w-40 self-center flex items-center justify-center !rounded-full md:mb-10"
      >
        Enter
