import { PlanetaryCompleteData, PlanetType } from 'mystyc-common';
...
export default function ProfileInteractionPanel({ href, planet, heading, subheading, score, totals, data } : { 
  href: string,
  planet: PlanetType, 
  heading: string,
  subheading: string,
  ...
  return (
    <div className='flex flex-col'>
      ...
      <Link href={href} className='flex flex-col hover:!no-underline'>
        ...
        <Text variant='muted' className="!text-gray-400 !mt-2 !mb-4">{data.planetData.description}</Text>
