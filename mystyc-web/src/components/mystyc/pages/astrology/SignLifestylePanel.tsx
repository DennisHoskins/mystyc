    ...
    <div>
      <div className='flex flex-col'>
        <div className="flex space-x-2">
          ...
          <Heading level={3}>Lifestyle</Heading>
        </div>
        <Heading level={4}  className='mt-2 !text-gray-400'>Careers</Heading>
