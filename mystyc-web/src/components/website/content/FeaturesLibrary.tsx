  ...
  return (
    <div className='flex flex-col space-y-2'>
      <div className='flex space-x-2'>
        ...
        <Heading level={1}>Astrology Knowledge Library</Heading>
      </div>
      ...
      <Text variant='muted'>
        Learn about the 12 zodiac signs, planetary meanings, house systems, aspects, and traditional interpretations.
      </Text>
    </div>
  );
}