...
import type { AppTransitionRef } from '@/components/ui/layout/transition/AppTransition';
import type { PageTransitionRef } from '@/components/ui/layout/transition/PageTransition';
